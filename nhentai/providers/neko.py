...
from ..enums import Language, NekoEngine
...
class NekoTranslator(BaseTranslator):
    """
    ...
    def _upload(self, image_path: Path, tgt_lang: Language, engine: NekoEngine, force_proxy: dict | None) -> str:
